...
- NEVER allow direct production server access without approval flow (applies to certificate AND credential servers; Quick Connect refuses hosts matching a saved prod server)
