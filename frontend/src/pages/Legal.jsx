...
const DOCS = {
  privacy: {
    ...
    sections: [
      ...
      {
        h: 'Your rights',
        body: 'You can export every record we hold about you as a JSON archive from Profile → Export my data. You can delete your account from Profile → Delete account; the account is soft-deleted immediately, hidden from listings, and hard-purged after a 30-day grace window.',
      },
      {
        h: 'Contact',
        body: 'Questions about this instance — including data subject requests under GDPR or comparable regimes — should go to the operator of your Shellius deployment, not to the upstream project.',
      },
    ],
  },
  terms: {
    ...
    sections: [
      {
        h: 'Acceptable use',
        body: 'You may only access servers and resources that you have been explicitly authorized to access. Attempts to bypass approval workflows, exfiltrate the CA private key, or escalate privileges outside the policy engine are prohibited and will be logged and reported.',
      },
      {
        h: 'Account responsibility',
        body: 'You are responsible for safeguarding your account credentials. Every action taken under your account — including SSH connections, RDP sessions, and access requests — is attributed to you in the audit log.',
      },
      {
        h: 'Service availability',
        body: 'Shellius is provided on an "as is" basis. Operators may take the service offline for maintenance, upgrades, or incident response without prior notice.',
      },
      {
        h: 'Termination',
        body: 'Operators may suspend or terminate your access at any time for violation of these terms or for operational reasons.',
      },
    ],
  },
  eula: {
    ...
    sections: [
      {
        h: 'License grant',
        body: 'You are granted the right to use, copy, modify, and redistribute the Shellius source code under the terms of the AGPL-3.0. If you run a modified version as a network service, you must make the corresponding source code available to its users.',
      },
      {
        h: 'No warranty',
        body: 'Shellius is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the AGPL-3.0 for details.',
      },
      {
        h: 'Trademark',
        body: 'The Shellius name and logo are not part of the AGPL grant. You may not use them to endorse or promote derivative products without explicit written permission from the Shellius project maintainers.',
      },
      {
        h: 'Source code',
...
function Legal() {
  ...
  // Legal pages are public: send signed-out readers back to sign-in.
    ...
    return (
      <AuthShell>
        <div className="w-full max-w-md rounded-lg border border-border bg-card p-6 text-center shadow-sm">
          ...
          <Link to={back.to} className="mt-4 inline-flex items-center gap-1 text-sm text-primary hover:underline">
