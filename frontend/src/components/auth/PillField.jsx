...
const PillField = forwardRef(function PillField(
  ...
  return (
    <div
      className={cn(
        'group relative flex h-10 w-full items-center rounded-[calc(var(--radius)-2px)] border border-transparent bg-foreground/[0.035] pl-4 pr-1 dark:bg-foreground/[0.05] transition-colors',
