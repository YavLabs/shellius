...
/**
 * PillField — Fey-style rounded field with an inline circular submit arrow
...
const PillField = forwardRef(function PillField(
  ...
  return (
    <div
      className={cn(
        'group relative flex h-12 w-full items-center rounded-full border border-transparent bg-foreground/[0.035] pl-5 pr-1.5 dark:bg-foreground/[0.05] transition-colors',
