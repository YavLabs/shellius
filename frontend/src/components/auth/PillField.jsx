...
const PillField = forwardRef(function PillField(
  ...
  return (
    <div
      className={cn(
        'group relative flex h-12 w-full items-center rounded-[calc(var(--radius)-2px)] border border-transparent bg-foreground/[0.035] pl-4 pr-2 dark:bg-foreground/[0.05] transition-colors',
