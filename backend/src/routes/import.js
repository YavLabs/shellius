...
const TEMPLATES = {
  ...
  servers:
    'hostname,ipAddress,customer,environment,protocol,sshUser,password,keyFile,sudoPassword,rdpUsername,rdpPassword,labels\n' +
    'web-01,10.0.0.10,acme,prod,ssh,ubuntu,,keys/web-01.pem,,,,team:web;tier:frontend\n',
