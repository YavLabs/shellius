...
export function render({ recipientName, code, minutes }) {
  ...
  const bodyHtml = `
    ...
    <div style="margin:24px 0;text-align:center">
      <span style="display:inline-block;padding:14px 28px;background:#f4f4f5;border:1px solid #e4e4e7;border-radius:8px;font:700 28px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:6px;color:#09090C">${safeCode}</span>
    </div>
